...
```
cd existing_repo
git remote add origin https://gitlab.com/ska-telescope/src/src-service-apis/ska-src-astroquery.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ska-telescope/src/src-service-apis/ska-src-astroquery/-/settings/integrations)
